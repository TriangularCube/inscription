...
// Disabling above because we're dealing with specific number of
//   elements in arrays we control

import { shuffle } from 'lodash-es'
import { EventCard, EventCardsSeed } from '@inscription/common/gameplay'
